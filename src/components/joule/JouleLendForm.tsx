...
export default function JouleLendForm({
  ...
  async function handleSubmit(values: {
    ...
    const confirmMessage = `Lend ${amount} tokens to position ${values.positionId.slice(0, 10)}... from ${formatAddress(
      address,
    )}?`;
  ...
  return (
    ...
    >
      ...
      <Form.TextField
        ...
        info="The position ID to lend to"
      />
      <Form.Dropdown
        id="newPosition"

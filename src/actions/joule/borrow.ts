...
/**
 * Borrow APT, tokens or fungible asset from a Joule position
 ...
 * @example
 * ```ts
 * const result = await borrowToken(privateKeyHex, "0x1::aptos_coin::AptosCoin", amount, positionId, 8, false, "mainnet");
 * ```
 */
